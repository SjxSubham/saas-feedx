    ...
    <div>
      ...
      <div className="flex justify-between items-start">
        <div className="proj-info">
          <div>
            <h1 className="text-3xl text-white font-bold mb-3 px-5">
              {project.name}
            </h1>
            <h2 className="text-primary-background text-white font-mono text-xl py-1 px-5">
              {project.description}
            </h2>
          </div>
          <div className="flex flex-col">
            {project.url ? (
              <Link
                href={project.url}
                className="rounded-lg w-fit bg-gradient-to-r from-purple-600 to-blue-500 dark:text-blue-100 text-white flex items-center p-2 gap-1 mb-2 mt-4"
              >
            ...
            <Link
              ...
              className="w-fit rounded-lg bg-gradient-to-r from-purple-600 to-blue-500 dark:text-blue-100 text-white p-2 gap-1 mb-2 flex items-center mt-2 px-2"
            >
              <Code className="h-5 w-5 mr-1" />
              <span className="text-md">Share Link / Embed Code</span>
            </Link>
          </div>
        </div>
      </div>
