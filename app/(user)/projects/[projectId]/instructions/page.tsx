...
// import { ChevronLeft, ClipboardCopy, CornerUpLeft, Link2, Share2 } from "lucide-react";
...
//         <Button className="bg-indigo-400 flex items-center mb-2 w-fit hover:bg-indigo-500"><CornerUpLeft className="h-5 w-5 mr-1" /><span className="text-lg">Return To Project</span></Button>
//       </Link>
//       </div>
//       <h1 className="text-xl font-bold mb-2">Start Collecting Feedback</h1>

//       <div className="bg-gray-300 p-6 rounded-md mt-6 relative">
//       <h1 className="text-2xl font-semibold font-mono text-secondary-foreground">Share the link Others to Collect Feedback</h1>
//       <h2 className="text-xl font-mono text-center font-bold  py-4 bg-gradient-to-r from-gray-400 via-gray-700 to-gray-950 text-transparent bg-clip-text "> Your Project-ID :  {params.projectId}</h2>
//       <div className="flex justify-center w-full">
//       <Link href="https://feed-x-widget.vercel.app/">
//       <Button

//       className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... flex items-center mb-3 w-fit"><Share2 className="h-5 w-5 mr-1" /><span className="text-lg">Share Link</span></Button>
//       </Link>
...
//       <p className="text-lg font-semibold font-mono text-secondary-foreground">Embed the code in your site</p>
//       {/* <p className="p-1 text-right">[[Built Your Own Feedback reciever Widget...!!]]</p> */}
...
const page = ({ params }: { params: { projectId: string } }) => {
  ...
  const widgetUrl = `https://feed-x-widget.vercel.app/?projectId=${params.projectId}`; // Pass projectId dynamically
