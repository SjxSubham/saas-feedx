    ...
    return (
        <div>
            <div className="flex items-center justify-center gap-3">
                <h1 className="text-3xl font-bold font-mono text-center my-4">Your Projects List</h1>
                {/* {userProjects.length < maxFreeProjects && (
            <p className="text-muted-foreground">You can only add: {maxFreeProjects - userProjects.length}</p>
        )} */}
            </div>
